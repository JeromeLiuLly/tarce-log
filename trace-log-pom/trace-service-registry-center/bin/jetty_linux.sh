...
function start {
	...
	$JAVA_CMD   $JAVA_OPTS -Dloader.path="lib/*" -jar   $BASE_HOME/$APP_JAR --spring.config.location=file:/home/trace-properties/trace-service-registry-center/ >> /data/trace-log/service-registry-center/"$log_file_url"  2>&1 &              echo "started $APP_JAR"
}
